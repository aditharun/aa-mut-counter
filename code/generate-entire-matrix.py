...
listdirectory = []
for study in list_study_dirs:
    contains_pattern = [study in item for item in cldirlist1]
    filtered_list = [item for item, flag in zip(cldirlist1, contains_pattern) if flag]
    listdirectory.append(filtered_list)

listdirectory = [item for sublist in listdirectory for item in sublist]

cldirlist1 = listdirectory
